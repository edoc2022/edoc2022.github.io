      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-10 mx-auto">
            ...
            <h2 className="text-black mb-4 text-uppercase">26<sup>th</sup> International EDOC Conference (EDOC 2022)</h2>
            <h3 className="text-black mb-4">Enterprise Design, Operations and Computing</h3>
            <h3 className="text-black mb-4">3-7 October 2022, Bozen-Bolzano, Italy</h3>
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-lg-8 mx-auto">
            <p className="text-black text-justify">
              ...
              EDOC 2022 will be collocated with the 28th International Conference on Cooperative Information Systems (CoopIS), and will take place in the beautiful region of South Tyrol in the Italian Alps.
        ...
        <div className="row">
          <div className="col-lg-8 mx-auto text-justify">
            <h3 id="topics" className="text-black mb-4 text-uppercase text-center">Topics</h3>
            ...
            <p className="text-black">
              ...
              <ul className="text-left">
                ...
                <ul>
                  ...
                  <li>Reference Architectures, Architecture Conceptualisation & Evaluation</li>
                  <li>System architectures</li>
                  <li>Interoperability and collaboration</li>
                  <li>Cloud computing and the evolution of enterprise architectures</li>
                </ul>
                ...
                <ul>
                  ...
                  <li>Governance in Service-oriented architectures (SOA/SOEA)</li>
                ...
                <ul>
                  ...
                  <li>Analysis and design techniques for non-functional requirements</li>
                ...
                <ul>
                  ...
                  <li>Threat modeling, attack simulation, intrusion detection and prevention</li>
                ...
                <ul>
                  <li>Process modeling, verification, configuration, architectures and implementations</li>
                  <li>Process mining and business analytics</li>
                  <li>Cloud impact on BPM, business processes in the cloud</li>
                  <li>Business process agility/flexibility and decision management</li>
                  <li>Business rule languages and engines, process compliance</li>
                ...
                <ul>
                  ...
                  <li>Taxonomies, ontologies and business knowledge integration</li>
                  <li>Enterprise ontologies</li>
                  <li>Master data management, data mining and (real-time) data</li>
                  <li>warehousing, data lakes</li>
                  <li>Complex event processing and event-driven architectures</li>
                  <li>Data quality and trustworthiness</li>
                  <li>Combining data-driven and symbolic modeling approaches</li>
                </ul>
              </ul>
            </p>
          </div>
        ...
        <div className="row">
          <div className="col-lg-8 mx-auto text-justify">
            <h3 id="guidelines" className="text-black mb-4 text-uppercase text-center">Submission Guidelines</h3>
            ...
            <p className="text-black">
              ...
              Scientific papers should describe original results, not having been accepted or submitted for publication elsewhere. These papers will be peer reviewed based on their scientific and technical contribution, originality, and relevance.
              ...
              All papers will be refereed by at least 3 members of the international programme committee. The proceedings will be published by Springer in the Lecture Notes in Computer Science (LNCS) series.
              
              <br/><br/>

              Full papers should follow the <Link to="https://www.springer.com/gp/computer-science/lncs/conference-proceedings-guidelines">Springer LNCS style</Link>. The page limit for submitted papers (as well as for final, camera-ready papers) is 16 pages (including references). An <Link to="https://www.overleaf.com/latex/templates/springer-lecture-notes-in-computer-science/kzwwpvhwnvfj#.WuA4JS5uZpi">Overleaf LaTeX template</Link> is available for your convenience. 
              ...
              Papers should be submitted at <Link to="https://easychair.org/my/conference?conf=edoc2022"><i>https://easychair.org/my/conference?conf=edoc2022</i></Link>
        ...
        <div className="row">
          <div className="col-lg-8 mx-auto text-justify">
            <h3 className="text-black mb-4 text-uppercase text-center">Post-Conference Publication</h3>

            <p className="text-black">
              The authors of selected papers will be invited to prepare a substantially revised and extended version to a Special Issue in <i>Elsevier's Information Systems</i> (JCR 2020 Impact Factor 2.309).
            </p>
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-lg-8 mx-auto text-justify">
            <h3 id="important-dates" className="text-black mb-4 text-uppercase text-center">Important Dates</h3>

            <p className="text-black">
              <ul>
                <li>Mandatory abstract submission <b>(strict deadline): 20 May 2022</b></li>
                <li>Full paper submission <b>(strict deadline): 27 May 2022</b></li>
                ...
                <li>Camera ready paper & author registration (main conference and workshops): 15 August 2022</li>
